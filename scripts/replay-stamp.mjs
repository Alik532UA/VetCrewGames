 ...
 *                                                 зміна перепрогону не міняє, або
 *                                                 версія ще не виїхала (і це записано
 *                                                 в її докблоці в roomRules.ts)
 ...
 * самої версії можна лише з `--same=<гра>`: це рішення «перепрогін той самий» (або
 * «ця версія ще не виїхала, і зміна йде під нею»), і воно видне в диффі, а не
 * робиться мовчки.
 */
