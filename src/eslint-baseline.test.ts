...
describe('базовий набір ESLint (CODE-QUALITY-v8 § 6.4.1)', () => {
	...
	beforeAll(async () => {
		...
		// 90 с, а не 30: 2026-09-26 хук вичерпав і 30 с — у повному прогоні, поруч із
		// тестом зонда правил, що запускає дочірні процеси node (`rules-live-probe`).
		// Окремо файл проходить за секунди; межа тут — від навантаження, а не від ESLint.
	}, 90_000);
