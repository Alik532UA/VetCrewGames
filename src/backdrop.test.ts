...
const BACKED_BY_PARENT: Record<string, string> = {
	...
	// Вибір швидкості кімнати: кнопки свій фон мають, а підпис групи (`legend`) —
	// ні, і саме його бачить ця перевірка. Компонент кладуть ЛИШЕ в панель
	// налаштувань лобі (`.lobby__panel--settings` в `OnlineLobby`, куди його передає
	// сніпетом `QuizLobby`), поруч із набором ігор, — і власний фон під підписом був
	// би панеллю на панелі, з видимим швом на межі. Той самий випадок, що в
	// `SegmentedChoice` двома рядками вище.
