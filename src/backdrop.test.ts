...
const BACKED_BY_PARENT: Record<string, string> = {
	...
	// ні, і саме його бачить ця перевірка. Компонент кладуть ЛИШЕ в
	// `.quiz-lobby__games.text-panel`, поруч із набором ігор, — і власний фон під
	// підписом був би панеллю на панелі, з видимим швом на межі. Той самий випадок,
	// що в `SegmentedChoice` двома рядками вище.
	'src/lib/components/quiz/QuizPacePicker.svelte': 'вибір швидкості, фон дає .quiz-lobby__games',
	...
	// Набір ігор кладуть у панель — у лобі це `.quiz-lobby__games.text-panel`, у
	// формі входу він усередині фільтра, а той — у `.gate__panel`. Свій фон тут був
