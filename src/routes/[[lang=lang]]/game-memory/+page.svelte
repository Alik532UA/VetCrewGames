...
<style>
	...
	/*
	 * Сім колонок на типовій ширині — і рівно чотири ряди на 28 карток.
	 *
	 * Число колонок не задане, а виходить із мінімуму: 560px сторінки при
	 * мінімумі 72px і проміжку 4px дають сім. Задавати сімку прямо не можна —
	 * на телефоні вона лишилася б сімкою, і картка стала б завширшки з ніготь.
	 *
