...
<style>
	...
	.tools__btn {
		/*
		 * 32px, а не 44px, і це свідоме відхилення від власного стандарту
		 * сенсорної цілі.
		 *
		 ...
		 *
		 * Рівно 32, як і сусідній кубик у `OnlineGate`: доти було 28, і в одному
		 * ряду стояли кнопки двох розмірів — заміряно в браузері (32×32 проти
		 * 28×28). Різниця в чотири пікселі не помітна як задум, лише як недогляд.
		 */
		width: 32px;
		height: 32px;
		display: flex;
