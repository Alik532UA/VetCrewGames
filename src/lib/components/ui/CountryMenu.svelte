<script lang="ts">
	 ...
	 */
	$effect(() => (panel ? fitMenu(panel) : undefined));
...
<style>
	 ...
	 *
	 * `min-width: 100%` лишає панель не вужчою за кнопку: у звичайному режимі вона
	 * рівна їй, у компактному 100% — це 44px, тобто обмеження ні на що не впливає.
	 *
	 */
	.menu {
		position: absolute;
