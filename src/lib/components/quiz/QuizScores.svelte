...
<style>
	 ...
	 * гравців три, і правило мусить бути одне. Тут лишається тільки те, що
	 * стосується саме цього переліку.
	 *
	 * ПІСЛЯ `--answered` у порядку каскаду: обидва фарбують тло, і в відсутнього
	 * воно мусить перемагати. Той, хто відповів і потім зник, — найважливіший
	 * випадок: акцентна підкладка «він відповів» інакше читалася б як «усе гаразд».
	 */
	.scores__row {
		display: flex;
