...
<style>
	...
	.zone__plate {
		...
		min-width: 0;
		/*
		 * Місце під ряд карток зарезервоване завжди — 94px це висота покладеної
		 * страви, виміряна на зібраній сторінці: зображення 53 + проміжок 2 +
		 * два рядки підпису 30 + поля й рамка 8.
		 *
