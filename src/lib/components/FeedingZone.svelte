...
<style>
	...
	/*
	 * Телефон, стан розбору (`disabled` тут і означає «раунд зіграно»).
	 *
	 * Фото меншає до 100px: після відповіді воно вже нічого не вирішує, а лише
	 * нагадує, про кого мова, — поруч стоїть розбір, заради якого все й
	 * затівалося. У повний зріст воно давало зону на 379px, тобто пів екрана під
	 * одну картинку.
	 *
	 * Смітник стає стовпчиком, як зони тварин: рядок йому дали, поки він на всю
	 * сторінку, а у вузькій колонці розбору голова забирає 88px і тарілці
	 * лишається 41 при картці страви в 48 — тож її видно обрізаною.
	 */
