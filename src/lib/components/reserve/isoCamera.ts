 ...
 *
 * Нижня межа поїхала разом зі світом: при 18 пікселях на світову одиницю у вікно
 * влазило 70 одиниць — менша частина навіть НАЙМЕНШОЇ ділянки (100 у поперек).
 * Гравець не міг побачити власну землю цілою, хоч би як віддалявся.
 */
 ...
 *
 * Підібраний так, щоб у кадр одразу входила вся стартова ділянка: при 8 пікселях
 * на одиницю вікно 1264×630 показує 158×79 світових одиниць, а ділянка нікому не
 * відомого фонду — 100×100. Було 34 під світ, у якому ділянка мала 20 одиниць у
 * поперек; після зростання світу впʼятеро той самий масштаб показував кут.
 */
 ...
 *
 * Трохи менше за радіус світу: далі починається рівна земля до горизонту, і
 * возити туди камеру нема сенсу. Число ЗАЛЕЖИТЬ від радіуса — інакше після
 * подвоєння світу половина карти лишилася б недосяжною, а мінікарта показувала б
 * місця, куди не поїхати.
 */
export const MAX_PAN = WORLD_RADIUS * 0.8;
