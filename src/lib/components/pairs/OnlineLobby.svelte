...
<style>
	 ...
	 */
	/*
	 * Налаштування — на пʼяту частину ширші за сусідні стовпці, і це не смак: у них
	 * найширший елемент лобі, шкала раунду з ЧОТИРМА сегментами («Швидко …
	 * Не обмежений»), яка рядків не переносить. Заміряно: їй треба 317px, а рівна
	 * третина на 1120px дає панелі 320 — три пікселі запасу, і на межі 64rem
	 * (298px) вона вже не влазила. Із часткою 1.2 — 364px на 1120 і 340 на самій
	 * межі. QR і склад від цього не бідніють: їм лишається по 298px і більше.
	 */
