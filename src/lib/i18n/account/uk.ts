...
export const account: Record<string, string> = {
	...
	'account.infoFriends':
		'Друзі — це взаємна підписка, тож акаунт потрібен обом. Псевдонім і аватар задаються після входу, у профілі.',
	'account.infoSignIn':
		'Вхід у вже створений акаунт відкриває саме його — з його імʼям, псевдонімом і друзями. Рахунок і рекорди з цього браузера додаються до нього; незакінчені кімнати, створені до входу, в акаунт не переїжджають.',
	'account.infoRegister':
		'Реєстрація не починає гру заново. Гравець той самий, набране лишається з вами — і далі зберігається в акаунті, тобто відкривається на інших ваших пристроях.',
	'account.infoWhy':
		'Без акаунта працює все: грати, створювати кімнати, набирати очки. Але рахунок і рекорди тоді живуть лише в цьому браузері — і зникнуть разом із його даними.',
	...
	'account.avatarTitle': 'Аватарка',
	'account.avatarHint': 'Зберігається одразу, щойно виберете.',
	'account.avatarFailed': 'Не вдалося зберегти аватарку. Спробуйте ще раз.',
	'account.profileTitle': 'Профіль',
	'account.gameName': 'Імʼя в грі',
	'account.gameNameHint': 'Так вас бачать інші — у кімнаті й у таблиці лідерів.',
	'account.handle': '@нік для пошуку',
	'account.handleHint':
		'Малі латинські літери, цифри й підкреслення; від 3 до 20 символів. Саме за ним вас знайдуть друзі — імʼя в грі для пошуку не годиться, бо воно не унікальне.',
	...
	'account.privacyHint':
		'Ці перемикачі тримає сама база: вимкнене тут не видно нікому, а не лише на цьому екрані.',
	...
	'account.deleteHint':
		'Видалення незворотне: зникнуть профіль, псевдонім, підписки, рахунок і рекорди.',
