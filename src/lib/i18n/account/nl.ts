...
export const account: Record<string, string> = {
	...
	'account.avatarHint': 'Wordt meteen opgeslagen zodra je kiest.',
	'account.avatarFailed': 'Avatar kon niet worden opgeslagen. Probeer het nog eens.',
	...
	'account.avatarTakenBy': 'bezet door {name}',
