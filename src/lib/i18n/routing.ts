...
export const LANGUAGE_ROUTES = {
	 ...
	 */
	/**
	 * Акаунт — окрема адреса, а не модальне вікно.
	 *
	 * Тут вхід, профіль, пошук людей і підписки: чотири блоки, які читають і
	 * заповнюють, а не «підтверджують і закривають». Модальне вікно на таке
	 * не годиться — його не надіслати посиланням і не відкрити другою
	 * вкладкою.
	 */
	...
	/**
	 * Спільна вікторина — окрема адреса, з тієї самої причини, що й у «Знайди
	 * пару»: її відкривають другою вкладкою, надсилають посиланням і вертаються в
	 * неї кнопкою «назад» без втрати кімнати. `?room=NN` теж живе тут.
	 */
	'quiz/online': '/[[lang=lang]]/quiz/online',
	pairs: '/[[lang=lang]]/pairs',
	/**
	 * Спільна партія «Знайди пару» — окрема адреса, а не стан усередині гри.
	 *
	 * Так її можна відкрити другою вкладкою, надіслати посиланням і повернутися в
	 * неї «назад» без втрати кімнати. Стан усередині гри всього цього не дає.
	 */
	'pairs/online': '/[[lang=lang]]/pairs/online',
