export const ui = {
	...
	'pairs.privateRoom': 'Закрита кімната',
	'pairs.privateRoomHint': 'Закритої кімнати немає в списку — зайти можна лише за кодом.',

	// Імена команди для спільної партії. ЦІЛІ фрази: складання прикметника з
	// іменником вимагало б узгодження роду (див. `config/crewNames.ts`).
	'pairs.crew1': 'Головний Лікар',
	'pairs.crew2': 'Добра Медсестра',
	'pairs.crew3': 'Юний Ветеринар',
	'pairs.crew4': 'Сміливий Доглядач',
	'pairs.crew5': 'Нічний Чергувальник',
	'pairs.crew6': 'Пильний Санітар',
	'pairs.crew7': 'Терплячий Хірург',
	'pairs.crew8': 'Весела Няня',
	'pairs.crew9': 'Старший Зоолог',
	'pairs.crew10': 'Уважний Аптекар',
	'pairs.crew11': 'Тихий Помічник',
	'pairs.crew12': 'Мудрий Наставник',
	'pairs.crew13': 'Дбайлива Доглядачка',
	'pairs.crew14': 'Затятий Дослідник',
	'pairs.crew15': 'Лагідний Кінолог',
	'pairs.crew16': 'Спритний Стажер',
