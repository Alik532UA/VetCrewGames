export const ui = {
	...
	/*
	 * ПЕРЕЇЗД У ДРУГУ ОНЛАЙН-ГРУ після фіналу. Підпис називає гру, у яку
	 * переходять, а не дію: «зіграти в іншу» не каже, у що саме.
	 */
	'room.playPairs': 'Зіграти у «Знайди пару»',
	'room.playQuiz': 'Зіграти у «Вікторину»',
	'room.goNext': 'Перейти в нову кімнату',
	...
	'pairs.roomClosed': 'Кімнату закрито — партію завершено.',
	'pairs.roomLost': 'Кімната більше недоступна — зайдіть у неї знову.',
	'pairs.removed': 'Господар прибрав вас із кімнати.',
	'pairs.offline': 'Немає звʼязку з сервером — чекаємо, поки він повернеться.',
	'pairs.rulesChanged':
		'Правила сервера оновилися, а ця сторінка — стара, тож ходи не проходять. Оновіть сторінку: партія продовжиться з того самого місця.',
	'pairs.newBuild':
		'Вийшла нова версія гри. Оновіть сторінку — якщо ви були в кімнаті, повернетеся в неї ж.',
	'pairs.reload': 'Оновити сторінку',
	'pairs.noLead':
		'Господаря немає, а підхопити ведення нікому з тих, хто тут. Можна вийти з кімнати або створити нову.',
	'pairs.leaveRoom': 'Вийти з кімнати',
	'pairs.playNext': 'Грати в наступній партії',
	'pairs.roomOlder': 'Цю партію почато в старішій версії гри. Створіть нову кімнату.',
	'pairs.rulesMissing': 'Спільна гра ще не ввімкнена на сервері.',
	'pairs.netFailed': 'Не вдалося зайти в кімнату. Спробуйте ще раз.',
	'pairs.roomFull': 'Кімната заповнена — у ній уже дванадцять учасників.',
	'pairs.opponentGone': 'Суперник довго не грає.',
	'pairs.takeTurn': 'Забрати хід',
	/* Підпис для скрінрідера: смуга сама не каже нічого. `formatPlain` НЕ застосовувати. */
	'pairs.turnTimer': 'Час ходу',
	/*
	...
	'beta.clearConfirm': 'Точно стерти? Натисніть ще раз',
	'beta.tabProgress': 'позначено у вкладці',
	'beta.home': 'На головну',
	'beta.copyFailed':
	...
	'pairs.rulesStale':
		'Сервер не пускає в кімнату: ця сторінка й правила бази — різних версій. Оновіть сторінку; якщо не допоможе — нові правила ще не викладені.',
	'review.question': 'Питання',
	'review.of': 'з',
	'review.correct': 'правильно',
	'review.incorrect': 'неправильно',
	'review.partial': 'частково',
	'review.back': 'До поточного питання',
	'review.backToResults': 'До підсумку',
	'review.list': 'Питання партії'
} as const;
