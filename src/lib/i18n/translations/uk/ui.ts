export const ui = {
	...
	/*
	 * «звʼязку», а не «зʼязку»: у слові пропала «в», і на екрані стояв не-існуючий
	 * покруч. Українською це «звʼязок» → «звʼязку»; апостроф тут типографський
	 * (U+02BC), як в усьому проєкті, а не машинописний.
	 */
	'pairs.away': 'немає звʼязку',
	...
	'pairs.roomsUnavailable':
		'Перелік кімнат недоступний. Зайти за кодом і створити кімнату можна й без нього.',
	...
	'debug.copyFailed': 'Не вдалося скопіювати. Виділіть текст і скопіюйте вручну:',
	...
	'pairs.rulesStale':
		'Сервер не пускає в кімнату. Найчастіша причина — правила бази старіші за цю версію гри.'
} as const;
