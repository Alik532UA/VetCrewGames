...
describe('вікно очікування', () => {
	...
	it('питання ставиться лише тому, хто ще не голосував', () => {
		expect(source, 'після свого голосу мусить стояти твердження, а не питання').toContain(
			"iVoted ? 'quiz.awayWaiting' : 'quiz.awayDecide'"
		);
	});
});
