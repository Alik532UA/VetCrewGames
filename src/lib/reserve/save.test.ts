...
describe('міграція', () => {
	/**
	 * Реєстр сходинок порожній, бо схема ще не мінялася, — а механізм перевірено
	 * підставними сходинками. Інакше перша ж СПРАВЖНЯ міграція була б і першим
	 * запуском самого механізму, до того ж на чужій партії.
	 */
	it('реєстр порожній: схема ще жодного разу не мінялася', () => {
