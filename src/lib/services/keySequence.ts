 ...
 * проєктах цей самий жест писали з нуля щоразу, і виходило по-різному: у `Slovko`
 * бракувало вікна між натисканнями й перевірки модифікаторів, у `MindStep` не було
 * жодного обмеження — там затиснута `R` у полі пошуку витирала всі локальні дані за
 * дві секунди без запитання. Обидва проєкти перейшли на цей модуль 2026-08-19, тож
 * приклади в минулому часі; вони лишаються, бо саме вони й були причиною винести
 * логіку туди, де в неї є тести.
 *
