...
/**
 * НАЙБІЛЬШИЙ НОМЕР ХОДУ — та сама межа, що в правилі `moves/$seq` (аудит 2026-09-26).
 * Шість цифр ключа пускали мільйон ходів у кімнату, а журнал перечитує кожен
 * учасник на кожен знімок; найдовша партія — сотні ходів, а реванш журнал стирає.
 * Звіряє з правилами `cloud-database.test.ts`.
 */
export const MOVE_SEQ_MAX = 9_999;
