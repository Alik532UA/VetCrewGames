 ...
 * зникнення не почути. Його переписує розклад (`refreshMs` нижче): друга вкладка
 * господаря повертає запис на наступному ударі серцебиття, а не «до наступного
 * обриву», як тут стояло до появи розкладу (аудит 2026-09-26).
 *
